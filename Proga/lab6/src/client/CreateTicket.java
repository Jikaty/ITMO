...
public class CreateTicket {
	...
	public Ticket getTicket() {
		return new Ticket(registerTicketName(), new Coordinates(registerCoordinateX(),registerCoordinateY()),registerTicketPrice(),registerTicketType(),registerPerson());
	}
	public CreateTicket(Scanner scanner, boolean isScriptMode) {
